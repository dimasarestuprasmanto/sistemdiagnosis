...
class ImportUji extends CI_Controller
{
    ...
    public function excel()
    {
        ...
        if ($check_rule['total'] > 0) {
            ...
            $this->session->set_flashdata('success', 'Data Gagal Di import karena data rule kosong! Silahkan import data training di menu Data Training ATAU data pakar di menu Rule telebih dahulu');
            redirect(base_url('admin/importuji'), 'refresh');
        }
    }
}
