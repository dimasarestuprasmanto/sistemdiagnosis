                            ...
                            <tbody>
                                <?php foreach ($datapengguna as $rows) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="user/edit/<?= $rows->id_user ?>" class="btn-sm btn-inverse-info btn-icon">
                                                <i class="mdi mdi-lead-pencil"></i>
                                            </a>
                                            &nbsp;
                                            <a href="user/hapus/<?= $rows->id_user ?>" class="btn-sm btn-inverse-danger btn-icon" onclick="return confirm('Apakah anda yakin ingin menghapus');">
